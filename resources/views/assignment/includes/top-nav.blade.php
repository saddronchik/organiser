            ...
            <div class="nav-wrapper d-flex justify-content-between">
                <ul class="nav">
                    ...
                    <li class="nav-item dropdown pt-3">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#executorModal">Новый
                                исполнитель</a>
                            <a class="dropdown-item" href="#" data-toggle="modal"
                               data-target="#departmentModal">Новое подразделение</a>
                        </div>
                    </li>
                </ul>
                ...
                <div class="top-nav_actions">
                    <button class="btn showd-sm rounded  btn-grad" id="add-assignment-btn" data-toggle="modal"
                            data-target="#add-assignment-modal" style="background-color: #2f66ff; color: white;">Создать поручение</button>
                </div>
            </div>
